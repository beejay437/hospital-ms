...
router.get('/:id', authenticate, authorize('admin','doctor','nurse'), ctrl.getRecord);
router.put('/:id', authenticate, authorize('admin','doctor'), ctrl.updateRecord);

router.post('/:recordId/prescriptions',
  authenticate, authorize('admin','doctor'),

...
import {
  LayoutDashboard, Users, Calendar, UserCog, BedDouble,
  Receipt, Pill, LogOut, Hospital, ChevronRight, X,
...
const navItems = [
  {
    ...
    roles: ['admin', 'receptionist', 'doctor', 'nurse', 'pharmacist', 'billing_officer'],
  },
  {
    href: '/patients',
    label: 'Patients',
  ...
  },
  {
    ...
    label: 'Billing',
    icon: Receipt,
    roles: ['admin', 'billing_officer', 'receptionist'],
  },
  {
    href: '/pharmacy',
    label: 'Pharmacy',
